...
CREATE TABLE `student_answer` (
  ...
  KEY `fk_sa_exam` (`exam_id`),
  KEY `fk_sa_question` (`question_id`),
  CONSTRAINT `fk_sa_exam` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`),
  CONSTRAINT `fk_sa_question` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_sa_student` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`)
...
-- Dump completed on 2026-01-11 16:18:55
